...
MODEL_PATH = "cnn_cifar10_augmentation_rotation_best.pth"
...
def main():
    ...
    plt.title("Matriz de confusão — CNN com augmentation e rotação")
    plt.tight_layout()
    plt.savefig("cnn_cifar10_augmentation_rotation_confusion_matrix.png", dpi=300)
    #plt.show()
    ...
    plt.xlabel("Época")
    plt.ylabel("Precisão")
    plt.title("Precisão — CNN com augmentation e rotação")

    plt.legend()
    plt.grid()

    plt.tight_layout()
    plt.savefig("cnn_cifar10_augmentation_rotation_accuracy.png", dpi=300)
    #plt.show()
    ...
    plt.xlabel("Época")
    plt.ylabel("Loss")
    plt.title("Loss — CNN com augmentation e rotação")

    plt.legend()
    plt.grid()

    plt.tight_layout()
    plt.savefig("cnn_cifar10_augmentation_rotation_loss.png", dpi=300)
    #plt.show()
