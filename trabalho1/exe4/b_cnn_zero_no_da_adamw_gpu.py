...
MODEL_PATH = "cnn_cifar10_adamw_best.pth"
...
def main():
    ...
    plt.title("Matriz de confusão — CNN com AdamW")
    plt.tight_layout()
    plt.savefig("cnn_cifar10_adamw_confusion_matrix.png", dpi=300)
    #plt.show()
    ...
    plt.xlabel("Época")
    plt.ylabel("Precisão")
    plt.title("Precisão — CNN com AdamW")

    plt.legend()
    plt.grid()

    plt.tight_layout()
    plt.savefig("cnn_cifar10_adamw_accuracy.png", dpi=300)
    #plt.show()
    ...
    plt.xlabel("Época")
    plt.ylabel("Loss")
    plt.title("Loss — CNN com AdamW")

    plt.legend()
    plt.grid()

    plt.tight_layout()
    plt.savefig("cnn_cifar10_adamw_loss.png", dpi=300)
    #plt.show()
