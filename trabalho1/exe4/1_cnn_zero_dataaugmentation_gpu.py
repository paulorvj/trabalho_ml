...
MODEL_PATH = "cnn_cifar10_best.pth"
...
def main():
    ...
    plt.title("Matriz de confusão — CNN treinada do zero")
    plt.tight_layout()
    plt.savefig("cnn_cifar10_confusion_matrix.png", dpi=300)
    #plt.show()
    ...
    plt.tight_layout()
    plt.savefig("cnn_cifar10_accuracy.png", dpi=300)
    #plt.show()
    ...
    plt.tight_layout()
    plt.savefig("cnn_cifar10_loss.png", dpi=300)
    #plt.show()
